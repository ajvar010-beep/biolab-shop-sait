/**
 * PostgreSQL миграция 005: Добавить / обновить тестовые товары в каталог
 * Idempotent — добавляет отсутствующие, обновляет существующие без картинок.
 */
...
const PRODUCTS = [
  {
    ...
    price: 450, category: 'Цветы', stock: 25, size: 'normal',
  ...
  },
  {
    ...
    price: 120, category: 'Овощи', stock: 40, size: 'normal',
  ...
  },
  {
    ...
    price: 80, category: 'Зелень', stock: 60, size: 'normal',
  ...
  },
  {
    ...
    price: 65, category: 'Рассада', stock: 30, size: 'normal',
  ...
  },
  {
    ...
    price: 890, category: 'Кустарники', stock: 15, size: 'large',
  ...
  },
  {
    ...
    price: 1500, category: 'Деревья', stock: 10, size: 'large',
  ...
  },
  {
    ...
    price: 45, category: 'Семена', stock: 100, size: 'normal',
  ...
  },
  {
    ...
    description: 'Готовая рассада огурцов для открытого грунта или теплице.',
    price: 55, category: 'Рассада', stock: 35, size: 'normal',
  ...
  },
  {
    ...
    price: 150, category: 'Цветы', stock: 50, size: 'normal',
  ...
  },
  {
    ...
    price: 40, category: 'Зелень', stock: 70, size: 'normal',
    imageUrl: 'https://images.unsplash.com/photo-1618378927878-7dc73682e8e3?w=400&h=300&fit=crop',
    images: '["https://images.unsplash.com/photo-1618378927878-7dc73682e8e3?w=800&h=600&fit=crop"]'
  }
];
...
module.exports = {
  ...
  async up(db) {
    ...
    for (const prod of PRODUCTS) {
      const existing = await db.findOne('products', { title: prod.title });
      if (!existing) {
        ...
        added++;
        console.log(`[Seed 005] Добавлен: ${prod.title}`);
      } else if (!existing.imageUrl) {
        // Товар есть, но без картинки — обновляем
        await db.updateOne('products', { _id: existing._id }, {
          imageUrl: prod.imageUrl,
          images: prod.images,
          updatedAt: now
        });
        updated++;
        console.log(`[Seed 005] Обновлён (картинка): ${prod.title}`);
      } else {
        console.log(`[Seed 005] Уже есть с картинкой: ${prod.title}`);
      }
    }

    console.log(`[Seed 005] Добавлено: ${added}, обновлено: ${updated}`);
  }
};
